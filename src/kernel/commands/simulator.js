...
import { makeEdgesAssignmentSimple } from "rabbit-ear/graph/make/edgesAssignment.js";
import { makeEdgesFoldAngleFromFaces } from "rabbit-ear/graph/make/edgesFoldAngle.js";
import { ExportModel, SimulatorFOLD } from "../../stores/Simulator.js";
import { UpdateFrame, IsoUpdateFrame } from "../../stores/Model.js";
...
export const saveSimulatorFoldAngles = () => {
	...
	creasePattern.edges_assignment = creasePattern.edges_assignment.map((a, i) =>
		assignKeep[a] ? a : newAssignments[i],
	);
