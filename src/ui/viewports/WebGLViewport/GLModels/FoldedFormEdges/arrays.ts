 ...
 * Rabbit Ear (c) Kraft
 */
import type { FOLD, WebGLElementArray } from "rabbit-ear/types.js";
 ...
 */
export const makeThickEdgesVertexArrays = (
 ...
 */
export const makeThickEdgesElementArrays = (
  gl: WebGLRenderingContext | WebGL2RenderingContext,
  version: number = 1,
  graph: FOLD = {}): WebGLElementArray[] => {
